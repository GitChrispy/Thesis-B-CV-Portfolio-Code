%Model 1
%Train using [adversarial + fuego non_smoke]
%Squeeze net
%Accuracy = 88.2%/0.12% on [adversarial test / fuego smoke images]

trainingSetup = load("C:\Users\jusfo\Desktop\Thesis B\Matlab Classification Model\trainingSetup_2020_07_01__12_00_59.mat");

imdsTrain = imageDatastore("C:\Users\jusfo\Desktop\Smoke Images\Classification_Dataset_Split","IncludeSubfolders",true,"LabelSource","foldernames");

...
loc = fullfile('C:\Users\jusfo\Desktop\Smoke Images\Preprocessed Non_Smoke_Images','*.jpg'); %non smoke
files = dir(loc);
...
loc = fullfile('C:\Users\jusfo\Desktop\Smoke Images\Preprocessed Smoke_Images','*.jpg'); %smoke
files = dir(loc);
dataSourceSelected = files;

...
if createSmokeData
    ...
    targetLoc = fullfile('C:\Users\jusfo\Desktop\Smoke Images\Preprocessed Images V4\Smoke');
    addpath(initialLoc);

    for i = 1 : folderSize
        I = imread(files(i).name);
        I = imresize(I,[416,416]);
        C = featureExtractV4(I);
    ...
    targetLoc = fullfile('C:\Users\jusfo\Desktop\Smoke Images\Preprocessed Images V4\Non_Smoke');
    addpath(initialLoc);

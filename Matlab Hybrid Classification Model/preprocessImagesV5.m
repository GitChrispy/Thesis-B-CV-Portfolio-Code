...
% a more conservative approach preserving original RGBimage, 'blended'
% w/texture data
...
if createSmokeData
    ...
    targetLoc = fullfile('C:\Users\jusfo\Desktop\Smoke Images\Preprocessed Images V5\Smoke');
    addpath(initialLoc);

    for i = 1 : folderSize
        I = imread(files(i).name);
        I = imresize(I,[416,416]);
        C = featureExtractV5(I);
    ...
    targetLoc = fullfile('C:\Users\jusfo\Desktop\Smoke Images\Preprocessed Images V5\Non_Smoke');
    addpath(initialLoc);

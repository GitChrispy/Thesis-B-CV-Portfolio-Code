...
%[imds_training, imds_val, imds_testing] = createDatastore(); used to
%initialise split

%load('imds_split_Model3_HybridV3.mat');
load('imds_split_V5.mat');
...
[trainedNet, traininfo] = trainNetwork(training_ds,lgraph_2,opts);
